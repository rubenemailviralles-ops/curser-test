    ...
    <>
      <section className="py-24 seamless-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <button 
              onClick={openModal}
              className="group bg-white text-black hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold text-base transition-all duration-300 hover-pop-button flex items-center justify-center mx-auto shadow-lg animate-scale-in delay-600"
            >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-black border border-white/20 rounded-2xl p-6 max-w-md w-full relative transform transition-all duration-300 scale-100 translate-y-0">
            <button
              onClick={closeModal}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="industry-full-automation">Industry full automation</option>
                </select>
              </div>
